...
def sla_miss_callback_to_slack(dag, task_list, blocking_task_list, slas, blocking_tis): # 5개의 파라미터 필수
    ...
    for task in task_list.split('\n'): # task_list 파라미터가 \n으로 구분
        task_id = task.split(' ')[0] # 각 task_list 공백(' ')으로 구분
